package com.example.bottomsheetandroid.behavior;
...
import com.example.bottomsheetandroid.R;
...
public class BehaviorBottomSheet<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public BehaviorBottomSheet(Context context, AttributeSet attrs ) {
        ...
        if (attrs != null) {
            ...
            mState = a.getInt(R.styleable.CustomBottomSheetBehavior_defaultStates, STATE_ANCHOR_POINT);
        }
        a.recycle();
...
//            mCallback.onStateChanged(bottomSheet, state);
    ...
    /**
     * A utility function to get the {@link BehaviorBottomSheet} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link BehaviorBottomSheet}.
     * @param <V> Instance of behavior
     * @return The {@link BehaviorBottomSheet} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> BehaviorBottomSheet<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof BehaviorBottomSheet)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetBehaviorGoogleMapsLike");
        }
        return (BehaviorBottomSheet<V>) behavior;
    }
